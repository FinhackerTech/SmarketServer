...
--
-- Host: localhost    Database: smarket_user
-- ------------------------------------------------------
...
CREATE TABLE `user_manager` (
  `favourite_set` tinyblob DEFAULT NULL,
  `manager_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FKrse09v5mycdos1xotseeb1550` FOREIGN KEY (`id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-03-13 19:00:48
